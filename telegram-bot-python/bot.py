...
def credit_packages_keyboard():
    ...
    for pkg in CREDIT_PACKAGES:
        ...
        keyboard.append([InlineKeyboardButton(text, callback_data=f"credits_{pkg['credits']}")])
    keyboard.append([InlineKeyboardButton("◀️ Назад", callback_data="main_menu")])
    return InlineKeyboardMarkup(keyboard)

def currency_keyboard(purchase_type):
    keyboard = [
        [InlineKeyboardButton("💎 TON", callback_data=f"currency_{purchase_type}_TON")],
        [InlineKeyboardButton("💵 USDT", callback_data=f"currency_{purchase_type}_USDT")],
        [InlineKeyboardButton("₿ BTC", callback_data=f"currency_{purchase_type}_BTC")],
        [InlineKeyboardButton("Ξ ETH", callback_data=f"currency_{purchase_type}_ETH")],
